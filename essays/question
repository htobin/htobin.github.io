...
public static void main(String[] args) throws ParseException {
    ...
    &emsp;SimpleDateFormat sf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    </br>
    &emsp;String str3 = "1927-12-31 23:54:07";
    </br>
    &emsp;String str4 = "1927-12-31 23:54:08";
    </br>
   &emsp;Date sDt3 = sf.parse(str3);
    </br>
    &emsp;Date sDt4 = sf.parse(str4);
    </br>
    &emsp;long ld3 = sDt3.getTime() /1000;
    </br>
    &emsp;long ld4 = sDt4.getTime() /1000;
    </br>
    &emsp;System.out.println(ld4-ld3);
}
The output is:
</br>
353
